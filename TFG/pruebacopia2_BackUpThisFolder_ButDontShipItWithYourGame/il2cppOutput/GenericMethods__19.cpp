...
struct ExtensionDataWriteStatus_t845B8B45F23E1930F53E1876C5DE10B7C5C2CB85 
{
	uint8_t ___value__;
};
...
struct WriteStackFrame_t0CC4719C6FFC6CE075F03E260758587265CB9902 
{
	...
	bool ___PopStackOnEndCollection;
	bool ___IsIDictionaryConstructible;
	bool ___IsIDictionaryConstructibleProperty;
	bool ___PopStackOnEndObject;
	bool ___StartObjectWritten;
	bool ___MoveToNextProperty;
	int32_t ___PropertyEnumeratorIndex;
	uint8_t ___ExtensionDataStatus;
...
{
	Il2CppIUnknown* ___CurrentValue;
	JsonClassInfo_tFD8648573B07E8116BE3D07E1F9AB6304F192F1E* ___JsonClassInfo;
	char* ___KeyName;
	RuntimeObject* ___CollectionEnumerator;
	int32_t ___PopStackOnEndCollection;
	int32_t ___IsIDictionaryConstructible;
	int32_t ___IsIDictionaryConstructibleProperty;
	int32_t ___PopStackOnEndObject;
	int32_t ___StartObjectWritten;
	int32_t ___MoveToNextProperty;
	int32_t ___PropertyEnumeratorIndex;
	uint8_t ___ExtensionDataStatus;
	JsonPropertyInfo_t0E6375355942521C44D8B4614149908242A113EA* ___JsonPropertyInfo;
};
